...
def test_the_compiled_proto_agrees_with_the_recovered_text():
    ...
    try:
        ...
        # The pb2 is generated by the robot toolkit (not tracked); CI's SIL job has
        # protobuf installed but never compiles the protos, so the oracle is absent there.
        pytest.skip("TeleHealth_pb2 not generated here (run the robot-toolkit proto build)")
