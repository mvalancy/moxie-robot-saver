...
> cloud Deepgram path ([`perception-pipeline.md`](../runtime/perception-pipeline.md)); `CLOUD_TTS_ENGINE`/`VOICE_ID`
...
> [`perception-pipeline.md`](../runtime/perception-pipeline.md)). "Trill" is the on-device wake/VAD feature path.
...
---
📖 [Cloud protocol](../protocol/cloud-protocol.md) · [Content & conversation](../runtime/content-and-conversation.md) · [Reverse-engineering index](../README.md) · [Docs index](../../README.md)
