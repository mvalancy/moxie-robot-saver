...
- **Accessibility global settings** (mirror [`settings-schema.md`](../firmware/settings-schema.md)) —
...
> subset. Complements the render side in [`unity-assets.md`](../firmware/unity-assets.md).
...
---
📖 [Reverse-engineering index](../README.md) · [Behavior input events](behavior-input-events.md) · [Behavior markup](behavior-markup.md) · [Content & conversation](content-and-conversation.md) · [Unity assets](../firmware/unity-assets.md)
