...
> `persistentDataPath`, see [content-and-conversation](../runtime/content-and-conversation.md#where-the-data-lives)).
...
- Each `NodeFallback` carries a **`Context`** (the [ChatScript context](../runtime/content-and-conversation.md) to
...
described in [content-and-conversation](../runtime/content-and-conversation.md#the-recommender)):
