...
| Capability | Where |
|---|---|
| QR pairing / Wi-Fi / VPN / **endpoint re-home** + debug/factory codes | [qr-commands](../reverse-engineering/qr-commands.md) |
| Wi-Fi support (Open/WPA2-PSK/hidden; + post-pairing push) | [qr-commands](../reverse-engineering/qr-commands.md#wi-fi-provisioning-support-what-networks-work) |
| Runtime config surface (199 settings) | [settings-schema](../reverse-engineering/settings-schema.md) |
| A/B OTA; **MCU (STM32)** + **XMOS DSP** firmware update | [ota-and-recovery](../reverse-engineering/ota-and-recovery.md) · [hardware-map](../reverse-engineering/hardware-map.md) · [perception-pipeline](../reverse-engineering/perception-pipeline.md) |
| Backup/restore; health telemetry; time sync (NTP) | [cloud-protocol](../reverse-engineering/cloud-protocol.md) · [network-trust](../reverse-engineering/network-trust.md) |
| Boot/lifecycle states; recovery; factory test suite | [boot-and-launcher](../reverse-engineering/boot-and-launcher.md) · [factory-provisioning](../reverse-engineering/factory-provisioning.md) |
