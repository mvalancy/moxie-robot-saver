...
- [`backlog/`](backlog/README.md) — **the build briefs**: a ranked audit line turned into something an agent
  ...
  and [`backlog/content-packs.md`](backlog/content-packs.md) (content packs: export, import-with-review,
  and a `source_version` upgrade that never clobbers a locally edited item).
