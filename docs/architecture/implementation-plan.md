...
| Content-module engine | [content-module](content-module-contract.md) | 🟢 engine + ContentApp runs conversations/globals through the AI seam (exec-code + action-plumbing deferred) | `mqtt/moxie_sdk/content/` |
