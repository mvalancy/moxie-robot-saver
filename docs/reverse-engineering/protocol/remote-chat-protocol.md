...
> [`content-and-conversation.md`](../runtime/content-and-conversation.md).
...
A revival server can leave these empty; they feed [the recommender + parent reports](../runtime/content-and-conversation.md#the-recommender),
