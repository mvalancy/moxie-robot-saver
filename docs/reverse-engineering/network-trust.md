...
[`boot-and-launcher.md`](boot-and-launcher.md)); the problem is you can't present a trusted cert for
...
---
📖 [Reverse-engineering index](README.md) · [Cloud protocol](cloud-protocol.md) · [OTA & recovery](ota-and-recovery.md) · [Docs index](../README.md)
