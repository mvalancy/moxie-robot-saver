...
> the robot's hardware to come up?** Pairs with [`hardware-map.md`](hardware-map.md) (the silicon),
> [`perception-pipeline.md`](perception-pipeline.md) (what the XMOS DSP does),
> [`security-policy.md`](security-policy.md) (why there's no custom HAL) and
> [`fcc-teardown.md`](fcc-teardown.md) (the radio module).
...
The XMOS front-end (AEC / beamforming / VAD / DOA — [`perception-pipeline.md`](perception-pipeline.md))
...
[`fcc-teardown.md`](fcc-teardown.md) for the exact radio blobs and the FCC-confirmed module.
...
[`hardware-access.md`](hardware-access.md) / [`ota-and-recovery.md`](ota-and-recovery.md).

---
📖 [Reverse-engineering index](README.md) · [Field guide](FIELD-GUIDE.md) · [Hardware map](hardware-map.md) · [Perception pipeline](perception-pipeline.md) · [Firmware reference](firmware-803-reference.md)
