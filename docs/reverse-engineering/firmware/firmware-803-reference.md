...
| `liblizzerface.so` | ~30 KB | **Lizard MCU** UART bridge — the `Lizzerface` native layer for motors/sensors/power/LED ([hardware-map](../hardware/hardware-map.md#raw-uart-command-set-lizzerfacecommands)), NOT a face renderer |
...
These carry the embedded protobuf `FileDescriptor`s → the [120 recovered `.proto` files](../protocol/recovered-proto/).
...
- **`OPEN_MOXIE` endpoint is built in** (`{"endpoint":"openmoxie"}`, `DEFAULT_ENDPOINT_NAME` in `libbo-logger`) — first-class community-server support (see [`cloud-protocol.md`](../protocol/cloud-protocol.md)).
- **`ServiceConfiguration.disable_verify`** present (maps to `CURLOPT_SSL_VERIFYPEER=0`) — see [`network-trust.md`](../protocol/network-trust.md).
...
[`ota-and-recovery.md`](ota-and-recovery.md) · [`cloud-protocol.md`](../protocol/cloud-protocol.md) ·
[`network-trust.md`](../protocol/network-trust.md) · [`robot-ipc-protocol.md`](../protocol/robot-ipc-protocol.md) ·
[`hardware-map.md`](../hardware/hardware-map.md) · [`perception-pipeline.md`](../runtime/perception-pipeline.md) ·
[`behavior-markup.md`](../runtime/behavior-markup.md) · [`content-and-conversation.md`](../runtime/content-and-conversation.md) ·
[`factory-provisioning.md`](factory-provisioning.md) · [`qr-commands.md`](../protocol/qr-commands.md)
